...
export abstract class VLMModerationManager {
  ...
  //   vlmDebug(VLMSessionManager.sessionUser.connectedWallet, user.connectedWallet)
  //   vlmDebug(VLMSessionManager.sessionUser.displayName, user.displayName)
  //   vlmDebug(VLMSessionManager.sessionUser.connectedWallet == user.connectedWallet)
  //   vlmDebug(VLMSessionManager.sessionUser.displayName == user.displayName)
  //   vlmDebug(VLMSessionManager.sessionUser.connectedWallet == user.connectedWallet || VLMSessionManager.sessionUser.displayName == user.displayName)
  ...
  //   }
  //   vlmDebug(Camera.instance.position.x, Camera.instance.position.y, Camera.instance.position.z)
  //   vlmDebug(Camera.instance.feetPosition.x, Camera.instance.feetPosition.y, Camera.instance.feetPosition.z)
  ...
  //     }
  //     vlmDebug(`in updateSettings within VLMModeration ${config}`)
  ...
  //       this.banAction();
  //     }
  //     vlmDebug(`Access Allowed: ${this.accessAllowed}`)
  //   };
  ...
  //   this.parcelBounds = [];
  //   this.sceneHeight = Math.vlmDebug(this.parcels.length + 1) * 20; // setting sceneHeight
